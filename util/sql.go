...
var CreateRecordsTable = "CREATE TABLE IF NOT EXISTS %s.%s (%s)"
...
var InsertRecord = "INSERT INTO %s.%s (%s) VALUES (%s)"
...
// DropTable takes schema, then table
var DropTable = "DROP TABLE IF EXISTS %s.%s"
